...
public final class receiveCheckOut_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t</head>\n");
      out.write("\t<body>\n");
      out.write("\t\t<button id=\"startButton\" onclick=\"start()\">Start</button>\n");
      out.write("\t\t<button onclick=\"stop()\">Stop</button>\n");
      out.write("\t\t\n");
      out.write("\t\t<button onclick=\"clearText()\">Clear</button>\n");
      out.write("\t\t\n");
      ...
      out.write("\t\t\t\teventSource = new EventSource(\"http://localhost:8088/eventStream\");\n");
